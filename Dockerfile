...
RUN apt-get update && apt-get install -y --no-install-recommends curl git ca-certificates flatpak flatpak-builder ostree gnupg2 elfutils xz-utils patch librsvg2-common && update-ca-certificates && rm -rf /var/lib/apt/lists/*
