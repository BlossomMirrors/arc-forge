...
RUN apt-get update && apt-get install -y --no-install-recommends curl git ca-certificates flatpak flatpak-builder ostree gnupg2 elfutils xz-utils && update-ca-certificates && rm -rf /var/lib/apt/lists/*
