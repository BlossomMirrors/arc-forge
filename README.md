...
| `R2_ACCOUNT_ID`               | Cloudflare account ID owning the `blossom-cdn` R2 bucket (EU jurisdiction) used for uploads                                                                                                                                     |
| `R2_ACCESS_KEY_ID`            | S3-compatible access key ID for the R2 bucket                                                                                                                                                                                   |
| `R2_SECRET_ACCESS_KEY`        | S3-compatible secret access key for the R2 bucket                                                                                                                                                                               |
